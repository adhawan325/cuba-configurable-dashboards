...
public class NonccdbTestContainer extends TestContainer {

    public NonccdbTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/non/confdash/app.properties",
    ...
    public static class Common extends NonccdbTestContainer {

        public static final NonccdbTestContainer.Common INSTANCE = new NonccdbTestContainer.Common();
